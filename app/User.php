...
class User extends Authenticatable implements JWTSubject
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','phone','code', 'lat', 'lang', 'avatar', 'role', 'checked','address','device_id','isNotify','type','city_id','active'
    ];
    ...
    {
        return $this->hasMany('App\Models\Suggestion', 'user_id', 'id');
    }

    public function complaints()
    {
        return $this->hasMany('App\Models\OrderComplaint', 'user_id', 'id');
    }
