...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-sm-12">
            <div class="card-box table-responsive boxes">
                ...
                <table id="datatable" class="table table-bordered table-responsives">
                    ...
                    <?php $__currentLoopData = $boxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="<?php echo e(appPath()); ?>/images/boxes/<?php echo e($row->image); ?>" target="_blank"><img src="<?php echo e(appPath()); ?>/images/boxes/<?php echo e($row->image); ?>" alt="user-img" width="60px" title="Mat Helme" class="img-circle img-thumbnail img-responsive"></a></td>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a href="#boxproducts<?php echo e($row->id); ?>" class="edit btn btn-primary" data-animation="fadein" data-plugin="custommodal"
                                        data-overlaySpeed="100" data-overlayColor="#36404a">
                                        <i class="fa fa-product-hunt"></i>
                                    </a>
                                    <div id="boxproducts<?php echo e($row->id); ?>" class="modal-demo">
                                        ...
                                        <form action="<?php echo e(route('EditBoxProducts')); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                            <?php echo e(csrf_field()); ?>

                                            <input type="number" hidden name="box_id" value="<?php echo e($row->id); ?>">
                                                           ...
                                                           <div class="col-md-6">
                                                               <select  class="form-control" name="product[]" required>
                                                                   <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                       <option value="<?php echo e($row->id); ?>" <?php echo e($item->product_id == $row->id ? 'selected' : ''); ?>><?php echo e($row->name_ar); ?></option>
                                                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                               </select>
                                                           </div>
                                                           <div class="col-md-4">
                                                           <input type="number" class="form-control" placeholder="عدد القطع من هذا النوع"   value="<?php echo e($item->quantity); ?>" id="product_ammount" name="ammounts[]" required>
                                                           </div>
                                                           <div class="col-md-2">
    ...
    <div id="add" class="modal-demo">
        ...
        <form action="<?php echo e(route('addBox')); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
    ...
    <div id="edit" class="modal-demo">
        ...
        <form id="edit" action="<?php echo e(route('updateBox')); ?>" method="post" autocomplete="off" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
    ...
    <div id="delete" class="modal-demo" style="position:relative; right: 32%">
        ...
        <div class="custombox-modal-container" style="width: 400px !important; height: 160px;">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form action="<?php echo e(route('deleteBox')); ?>" method="post">
                        <?php echo e(csrf_field()); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function addProductDiv(parentDivName){
            var products ;
             products += '<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>';
             products += '<option value="<?php echo e($item->id); ?>"><?php echo e($item->name_ar); ?></option>';
             products += '<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>';
