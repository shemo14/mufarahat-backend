...
@section('content')
                ...
                <table id="datatable" class="table table-bordered table-responsives">
                    ...
                    @foreach($qus as $qu)
                        <tr>
                            ...
                            <td>{{$qu->id}}</td>
                            <td>{{$qu->question_ar}}</td>
                            <td>{{$qu->question_en}}</td>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="#edit" class="edit btn btn-success" data-animation="fadein" data-plugin="custommodal"
                                        ...
                                        data-id     = "{{$qu->id}}"
                                        data-qu_ar  = "{{$qu->question_ar}}"
                                        data-qu_en  = "{{$qu->question_en}}"
                                    >
    ...
    <div id="edit" class="modal-demo">
        ...
        <form id="edit" action="{{route('editquestion')}}" method="post" autocomplete="off" enctype="multipart/form-data">
            {{csrf_field()}}
