...
@section('content')
   ...
   <div id="active" class="modal-demo" style="position:relative; right: 32%">
        ...
        <h4 class="custom-modal-title">تفعيل المندوب</h4>
        <div class="custombox-modal-container" style="width: 400px !important; height: 160px;">
            <div class="row">
                <div class="col-sm-12">
                    <h3 style="margin-top: 35px">
                        هل تريد مواصلة عملية التفعيل ؟
                    </h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <form action="{{route('activate')}}" method="post">
                        ...
                        <button style="margin-top: 35px" type="submit" class="btn btn-primary btn-rounded w-md waves-effect waves-light m-b-5 send-delete-all"  style="margin-top: 19px">تفعيل</button>
                    </form>
                </div>
            </div>
        </div><!-- /.modal-content -->
